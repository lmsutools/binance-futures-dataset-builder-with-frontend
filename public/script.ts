...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const periodSelect = document.getElementById('period') as HTMLSelectElement; // Period select
    const dateRangeInputsDiv = document.getElementById('dateRangeInputs') as HTMLDivElement; // Div containing date inputs
    const lastXInputsDiv = document.getElementById('lastXInputs') as HTMLDivElement; // Div containing last X inputs
    const rangeTypeDateRadio = document.getElementById('rangeTypeDate') as HTMLInputElement; // Date Range radio button
    const rangeTypeLastRadio = document.getElementById('rangeTypeLast') as HTMLInputElement; // Last X radio button
    const lastXDurationSelect = document.getElementById('lastXDuration') as HTMLSelectElement; // Last X duration select
    const startDateInput = document.getElementById('startDate') as HTMLInputElement; // Start Date input
    const endDateInput = document.getElementById('endDate') as HTMLInputElement; // End Date input
    ...
    const periodInfoDiv = document.getElementById('periodInfo') as HTMLDivElement; // Info text for period
    const dataInfoDiv = document.getElementById('dataInfo') as HTMLDivElement; // Div for data info
    ...
    const lastXDurations: { [key: string]: number } = {
        '1h': 60 * 60 * 1000,
        '2h': 2 * 60 * 60 * 1000,
        '4h': 4 * 60 * 60 * 1000,
        '6h': 6 * 60 * 60 * 1000,
    ...
    const toggleRangeInputs = (rangeType: string) => {
